...
export const translations: Translations = {
  en: {
    ...
    bidDisclaimer: 'Submitting a bid means you accept our auction rules.',
    ...
    participationNote: 'Winners receive project details privately. If they decline, the next highest bidder will be contacted.',
