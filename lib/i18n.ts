export const translations = {
  ru: {
    ...
    webStack: "Web Stack",
    webStackDesc: "Python, FastAPI, PostgreSQL, MongoDB, Redis",
    aiStack: "AI Stack",
    aiStackDesc: "OpenAI, Anthropic, LangChain, Vector DB, RAG, Fine-tuning",
    contactTelegram: "Написать в Telegram",
    contactYoutube: "Перейти на YouTube",
    contactBot: "Узнать больше",
    contactInstagram: "Instagram",
    telegramDesc: "Быстрая консультация и обсуждение проектов",
    youtubeDesc: "Полезные материалы",
    botDesc: "Подробная информация",
    instagramDesc: "Кейсы и новости",
    videos: [
  ...
  uk: {
    ...
    contactYoutube: "Перейти на YouTube",
    contactBot: "Дізнатися більше",
    contactInstagram: "Instagram",
    telegramDesc: "Швидка консультація та обговорення проектів",
    youtubeDesc: "Корисні матеріали",
    botDesc: "Детальна інформація",
    instagramDesc: "Кейси та новини",
    videos: [
